package com.sampleservice.bilibiliservice.controller;

import com.sampleservice.bilibiliservice.utils.MBaseUtils;
...
public class MainController extends MObject {
    ...
    public MResponse streamFunction(@RequestBody MResponse requestData) {
        ...
        if (requestData.get("interval") != null) {
            MBaseUtils.generateStringInKBSize(20, result, (long) requestData.get("interval"));
        }
        return result;
    }
}
